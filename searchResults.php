<?php
    ...
    if($currentPage=="plantInventory.php")
    ...
    if($currentPage=="customerManagement.php")
        if(isset($_POST['input'])){
            $input = $_POST['input'];
        ...
        <?php
            ...
            while($row=mysqli_fetch_array($result)){
                ?>
                <div class="Card"><a style="width:100%;height:100%;"href="customer_profile.php">
